...
- [ADR-043] Do not considering the source and target connections as routing points anymore
- [ADR-046] Add support for the edition of routing points
...
- https://github.com/eclipse-sirius/sirius-components/issues/1065[#1065] [diagram] Anchor positions will be updated according to the ELK layout after the use of the _Arrange all_. See ADR-043 for more details.
...
- https://github.com/eclipse-sirius/sirius-components/issues/966[#966] [diagram] Prevent edges from blinking while moving an element or during the refresh of a diagram
